...
public boolean tree(int modelId)
{
if(modelId == 1570 && modelId == 1637 && modelId == 8157 && modelId == 8131 && modelId == 8037 && modelId == 8023 && modelId == 1699 && modelId == 1667 && modelId == 1688)
{
return true;
} else {
return false;
...
scale2(4);
  ...
  public void method470(int i) {
    ...
    if (class36 == null)
      return;
    FrameList class18 = class36.aClass18_637;
    anInt1681 = 0;
    anInt1682 = 0;
    anInt1683 = 0;
