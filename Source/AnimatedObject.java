...
final class AnimatedObject extends Animable {
	...
	private ObjectDef method457()
	{
		...
		if(anInt1601 != -1)
		{
			VarBit varBit = VarBit.cache[anInt1601];//causes map issues? Objects
	...
	public AnimatedObject(int i, int j, int k, int l, int i1, int j1,
