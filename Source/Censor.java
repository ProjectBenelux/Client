...
final class Censor {
	...
	{
		ByteBuffer stream = new ByteBuffer(archive.getDataForName("fragmentsenc.txt"));
		ByteBuffer stream_1 = new ByteBuffer(archive.getDataForName("badenc.txt"));
		ByteBuffer stream_2 = new ByteBuffer(archive.getDataForName("domainenc.txt"));
		ByteBuffer stream_3 = new ByteBuffer(archive.getDataForName("tldlist.txt"));
